...
import { getTeamNamePlaceholder } from '@/utils/placeholders'
...
// 动态placeholder计算属性
const teamNamePlaceholder = computed(() => getTeamNamePlaceholder())
...
/* 移动端表单输入优化 */
.modal-content.mobile input[type="text"],
.modal-content.mobile input[type="time"],
.modal-content.mobile select {
...
.modal-content.mobile input[type="text"]:focus,
.modal-content.mobile input[type="time"]:focus,
.modal-content.mobile select:focus {
  border-color: #667eea;
  outline: none;
  box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1);
}

.modal-content.mobile .time-slot-editor {
  padding: 1rem;
  margin-bottom: 1rem;
  background: #f8f9fa;
  border-radius: 12px;
...
.modal-content.mobile .remove-btn {
...
.modal-content.mobile .add-slot-btn {
  min-height: 48px;
  font-size: 16px;
  border-radius: 8px;
  font-weight: 500;
